...
public class FactionAddPointsCommand extends CommandArgument
{
    public FactionAddPointsCommand(RevampHCF plugin) {
        super("addpoints", "add points to a faction", new String[] { "addfactionpoints" });
        this.permission = "*";
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        MessageUtils.sendMessage(CC.translate("&a&l" + sender.getName() + "&asuccessfully added &l" + newPoints + " &eto the faction &f" + faction.getName() + "&e."), "hcf.admin");
        return true;
    }
}
