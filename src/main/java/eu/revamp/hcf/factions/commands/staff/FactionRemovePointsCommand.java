...
public class FactionRemovePointsCommand extends CommandArgument
{
    public FactionRemovePointsCommand(RevampHCF plugin) {
        super("removepoints", "remove points to a faction", new String[] { "removefactionpoints" });
        this.permission = "*";
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        MessageUtils.sendMessage(CC.translate("&a&l" + sender.getName() + "&asuccessfully removed &l" + newPoints + " &eto the faction &f" + faction.getName() + "&e."), "hcf.admin");
        return true;
    }
}
