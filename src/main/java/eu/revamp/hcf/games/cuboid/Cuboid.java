...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable
{
    ...
    @Getter @Setter protected int x1;
    @Getter @Setter protected int y1;
    @Getter @Setter protected int z1;
    @Getter @Setter protected int x2;
    @Getter @Setter protected int y2;
    @Getter @Setter protected int z2;
    ...
    public List<Chunk> getChunks() {
        ...
        List<Chunk> result = new ArrayList<Chunk>(x2 - x1 + CHUNK_SIZE + (z2 - z1) * CHUNK_SIZE);
