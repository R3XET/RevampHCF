...
public class Kit implements ConfigurationSerializable {
    private static ItemStack DEFAULT_IMAGE = new ItemStack(Material.EMERALD, 1);
    ...
    public Kit(String name, String description, PlayerInventory inventory) {
        this(name, description, (Inventory) inventory, 0L);
    }
    ...
    public String getPermissionNode() {
        return "command.kit." + (RevampHCF.getInstance().getConfiguration().isKitMap() ? "" : "hcf.") + this.name;
    }
