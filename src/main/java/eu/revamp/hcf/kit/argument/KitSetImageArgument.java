...
public class KitSetImageArgument extends CommandArgument {
    ...
    public KitSetImageArgument(RevampHCF plugin) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.GRAY + "Set image of kit " + ChatColor.YELLOW + kit.getDisplayName() + ChatColor.GRAY + " to " + ChatColor.YELLOW + RevampHCF.getInstance().getItemDB().getName(stack) + ChatColor.GRAY + '.');
        return true;
    }
