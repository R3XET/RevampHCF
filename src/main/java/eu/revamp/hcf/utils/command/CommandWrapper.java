...
import eu.revamp.hcf.HCFSettings;
    ...
    public static void printUsage(CommandSender sender, String label, Collection<CommandArgument> arguments) {
        ...
        for (CommandArgument argument : arguments) {
            ...
            if (permission == null || sender.hasPermission(permission)) {
                sender.sendMessage(HCFSettings.PRIMARY_COLOUR + argument.getUsage(label) + HCFSettings.SECONDARY_COLOUR + " » " + ChatColor.GRAY + argument.getDescription() + '.');
            }
        }
    }
